//$ bin/sessionjc -cp tests/classes/ tests/src/places/onedimjacobi/ordinary/Master.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.onedimjacobi.ordinary.Master 4444 localhost 4442 localhost 4443
/**
 * 
 * @author Andi Bejleri
 *
