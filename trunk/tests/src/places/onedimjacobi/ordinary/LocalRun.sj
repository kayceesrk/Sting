//$ bin/sessionjc -cp tests/classes/ tests/src/places/onedimjacobi/ordinary/LocalRun.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.onedimjacobi.ordinary.LocalRun mt
