//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/noaliaz/LocalRun.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.noaliaz.LocalRun m false 1 1 1
