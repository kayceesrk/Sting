//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/noaliaz/Worker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.noaliaz.Worker false 4443 localhost 4444 1
