//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/noaliaz/FirstWorker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.noaliaz.FirstWorker false 4442 localhost 4443 1 1
...
import places.nbody.Particle;
import places.nbody.ParticleV;
