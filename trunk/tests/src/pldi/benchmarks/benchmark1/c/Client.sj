...
//$ bin/sessionj -cp tests/classes/ pldi.benchmarks.benchmark1.c.Client false localhost RMIBenchmarkObject 0 10 1
//$ tests/src/pldi/benchmarks/benchmark1/c/client.sh localhost RMIBenchmarkObject 0 
