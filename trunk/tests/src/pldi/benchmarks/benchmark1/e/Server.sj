//$ bin/sessionjc -cp tests/classes/ tests/src/pldi/benchmarks/benchmark1/e/Server.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ pldi.benchmarks.benchmark1.e.Server false 8888
...
import pldi.benchmarks.benchmark1.a.Kill;
