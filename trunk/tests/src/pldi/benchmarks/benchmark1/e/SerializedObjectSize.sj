//$ bin/sessionjc -cp tests/classes/ tests/src/pldi/benchmarks/benchmark1/e/SerializedObjectSize.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ pldi.benchmarks.benchmark1.e.SerializedObjectSize 1000
