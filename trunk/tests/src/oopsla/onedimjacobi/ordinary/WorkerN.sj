//$ bin/sessionjc -cp tests/classes/ tests/src/onedimjacobi/ordinary/WorkerN.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ onedimjacobi.ordinary.WorkerN 4442
