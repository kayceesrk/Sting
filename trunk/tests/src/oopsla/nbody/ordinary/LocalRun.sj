//$ bin/sessionjc -cp tests/classes/ tests/src/nbody/ordinary/LocalRun.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ nbody.ordinary.LocalRun f false 1 1 1
