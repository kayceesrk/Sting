//$ bin/sessionjc -cp tests/classes/ tests/src/nbody/noaliaz/LastWorker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ nbody.noaliaz.LastWorker false 4444 localhost 4442 1
