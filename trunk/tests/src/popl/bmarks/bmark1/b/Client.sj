...
//$ bin/sessionj -cp tests/classes/ popl.bmarks.bmark1.b.Client false localhost 8888 s 0 1 7 1
//$ tests/src/popl/bmarks/bmark1/b/client.sh localhost 8888 d 0 

//$ javac -cp lib/sessionj.jar';'lib/sessionj-rt.jar';'tests/classes/ tests/classes/popl/bmarks/bmark1/b/Client.java
...
{	
	...
	{
		cbegin.rec X[!{Y:!<NoaliasMessage>.?(NoaliasMessage).#X, N:}]
	}	
	...
	{		
		...
		for (int i = 0; i < num; i++) 
		{
			noalias NoaliasMessage msg = new NoaliasMessage(size);
