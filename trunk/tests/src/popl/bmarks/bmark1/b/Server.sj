...
//$ bin/sessionj -cp tests/classes/ popl.bmarks.bmark1.b.Server false 8888 d 5011

//$ javac -cp lib/sessionj.jar';'lib/sessionj-rt.jar';'tests/classes/ tests/classes/popl/bmarks/bmark1/b/Server.java
...
public class Server 
{
	...
	{
		sbegin.rec X[?{Y:?(NoaliasMessage).!<NoaliasMessage>.#X, N:}]
	}	
