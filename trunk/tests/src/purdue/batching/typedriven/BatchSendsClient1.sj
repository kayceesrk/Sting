...
//$ bin/sessionjc -cp tests/classes/ tests/src/purdue/batching/typedriven/BatchSendsClient1.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ purdue.batching.Client5  
