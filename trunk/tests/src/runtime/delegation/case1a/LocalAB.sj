//$ bin/sessionjc -cp tests/classes tests/src/runtime/delegation/case1a/LocalAB.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ runtime.delegation.case1a.LocalAB 8888 9999
