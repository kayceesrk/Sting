 ...
 * 
 */
public class SJNoAliasArrayTypeNode_c extends ArrayTypeNode_c implements
    SJNoAliasArrayTypeNode
{
	/**
	 * @param pos
	 */
	public SJNoAliasArrayTypeNode_c(Position pos, ArrayTypeNode atn)
	{
		super(pos, atn.base());
	}
