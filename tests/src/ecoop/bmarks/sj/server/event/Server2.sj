//$ bin/sessionj -cp tests/classes/ ecoop.bmarks.sj.server.event.Server2 false 8888 1
//$ bin/sessionj -Dsessionj.transports.session=a -cp tests/classes/ ecoop.bmarks.sj.server.event.Server2 false 8888 1
		      ...
		      typecase (s) 
		      {
		        ...
		        when(@(pReceive)) 
		        {
		          ...
		          if (counting) 
		          {
		            ...
		            debugPrintln("[Server2] Current count:" + count);		            
	            }
