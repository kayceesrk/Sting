...
//$ bin/sessionjc -cp tests/classes/ tests/src/purdue/multiparty/Multi3.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ purdue.multiparty.Multi3 &
