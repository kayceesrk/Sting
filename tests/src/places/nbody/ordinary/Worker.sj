//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/ordinary/Worker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.ordinary.Worker false 4443 localhost 4444 1
