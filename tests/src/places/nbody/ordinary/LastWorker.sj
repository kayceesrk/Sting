//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/ordinary/LastWorker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.ordinary.LastWorker false 4444 localhost 4442 1
