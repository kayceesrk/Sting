//$ bin/sessionjc -cp tests/classes/ tests/src/places/nbody/ordinary/FirstWorker.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.nbody.ordinary.FirstWorker false 4442 localhost 4443 1 1
