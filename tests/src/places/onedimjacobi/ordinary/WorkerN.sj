//$ bin/sessionjc -cp tests/classes/ tests/src/places/onedimjacobi/ordinary/WorkerN.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ places.onedimjacobi.ordinary.WorkerN 4442
/**
 * 
 * @author Andi Bejleri
 *
