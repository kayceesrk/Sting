//$ bin/sessionjc -cp tests/classes/ tests/src/benchmarks/delegation3/Alice.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ benchmarks.delegation3.Alice localhost 9999 2 1
