...
//$ bin/sessionj -cp tests/classes/ pldi/benchmarks/benchmark3/c/Alice false localhost 8888 0 1
//$ tests/src/pldi/benchmarks/benchmark3/c/alice.sh localhost 8888 0 -k localhost 9999 
