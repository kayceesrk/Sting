...
//$ bin/sessionj -cp tests/classes/ pldi.benchmarks.benchmark2.d.Server false 8888

/**
 * The same as benchmark1.a.Server except does not print any debug info.
 */
package pldi.benchmarks.benchmark2.d;
...
import pldi.benchmarks.benchmark2.c.Kill;
