...
//$ bin/sj -cp tests/classes/ pldi.benchmarks.benchmark1.b.Client false localhost 8888 0 10 1
//$ tests/src/pldi/benchmarks/benchmark1/b/client.sh localhost 8888 0 
