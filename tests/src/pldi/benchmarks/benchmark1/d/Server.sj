//$ bin/sessionjc -cp tests/classes/ tests/src/pldi/benchmarks/benchmark1/d/Server.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ pldi.benchmarks.benchmark1.d.Server false 8888
...
public class Server 
{
	...
	{				
		...
		public KillThread(int port, ServerSocket ss)
		{
			this.port = port;
			this.ss = ss;
		}
