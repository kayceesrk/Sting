// bin/sessionjc tests/src/runtime/delegation/case3/B.sj -d tests/classes/
// bin/sessionj -cp tests/classes/ runtime.delegation.case3.B 8888 localhost 9999
...
class B 
{
	...
	{
		final noalias protocol body { ?(String).?(?(String).!<String>) }
