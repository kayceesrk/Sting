//$ bin/sessionjc -cp tests/classes tests/src/runtime/delegation/case1b/LocalAC.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ runtime.delegation.case1b.LocalAC localhost 8888 9999
