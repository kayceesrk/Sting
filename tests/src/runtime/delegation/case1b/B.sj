// bin/sessionjc tests/src/runtime/delegation/case1b/B.sj -d tests/classes/
// bin/sessionj -cp tests/classes/ runtime.delegation.case1b.B 8888 localhost 9999
...
class B 
{
	...
	{
		final noalias protocol body { ?(int).!<int> }
