//$ bin/sessionjc -cp tests/classes tests/src/runtime/delegation/case1a/LocalABC.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ runtime.delegation.case1a.LocalABC 8888 9999
