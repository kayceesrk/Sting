//$ bin/sessionjc -cp tests/classes tests/src/runtime/delegation/case1a/LocalBC.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ runtime.delegation.case1a.LocalBC 8888 9999
