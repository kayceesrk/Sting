//$ bin/sessionjc -cp tests/classes/ tests/src/oopsla/chat/client/gui/ChatTab.sj -d tests/classes/
...
{	
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if (action.equals(SEND_ACTION)) 
		{
			...
			ChatClient.debugPrintln("[ChatTab] Sending message to " + getTabKey() + ": " + msg);
