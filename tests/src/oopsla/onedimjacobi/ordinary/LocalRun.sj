//$ bin/sessionjc -cp tests/classes/ tests/src/onedimjacobi/ordinary/LocalRun.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ onedimjacobi.ordinary.LocalRun fs
