//$ bin/sessionjc -cp tests/classes/ tests/src/onedimjacobi/ordinary/Master.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ onedimjacobi.ordinary.Master 4444 localhost 4442 localhost 4443

package onedimjacobi.ordinary;
