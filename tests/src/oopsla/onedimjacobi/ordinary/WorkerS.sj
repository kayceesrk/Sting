//$ bin/sessionjc -cp tests/classes/ tests/src/onedimjacobi/ordinary/WorkerS.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ onedimjacobi.ordinary.WorkerS 4443
