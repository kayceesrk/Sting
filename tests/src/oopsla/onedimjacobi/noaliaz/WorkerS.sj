//$ bin/sessionjc -cp tests/classes/ tests/src/onedimjacobi/noaliaz/WorkerS.sj -d tests/classes/
//$ bin/sessionj -cp tests/classes/ onedimjacobi.noaliaz.WorkerS 4443
			...
			while (true)
			{
				...
				{				
					...
					{			
						...
						Master.noaliasArrayCopy(ghost_m, newu[0], 1);
