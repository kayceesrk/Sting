...
// Need to associate with the socket (codebase eager, class cache, etc.);
...
public class SJClassResolver extends LoadedClassResolver
{
	...
	private SJTypeSystem sjts;

	private static final boolean ALLOW_RAW_CLASSES = true; // Move to SJConstants?
	...
	public Named find(String name) throws SemanticException
	{
		...
		if (clazz == null)
		{
			...
			{
				throw new SemanticException(cnfe);
			}
